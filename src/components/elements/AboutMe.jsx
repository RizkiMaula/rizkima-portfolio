  ...
  return (
    <div className="min-h-screen hero bg-base-200">
      <div className="flex-col gap-10 hero-content lg:flex-row">
        {/* img */}
        <div className="flex flex-col w-[50%] gap-4 p-4 text-center border-2 border-blue-200">
          <img
          ...
          <Link
            to={'#'}
            className="underline btn hover:bg-primary hover:text-white"
          >
            Download CV <FontAwesomeIcon icon={faDownload} />
          </Link>
        </div>
        {/* content */}
        <div className="flex flex-col border-2 border-cyan-200 w-[95%]">
          {/* information */}
          <div className="grid grid-cols-1 gap-4 p-4 border-2 md:grid-cols-2 border-ternary">
            <Link
              target="_blank"
          ...
          {/* introduction */}
          <div className="grid grid-cols-1 gap-5 p-1 border-1 border-ternary md:grid-cols-2">
